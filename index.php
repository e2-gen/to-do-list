                ...
                <?php if (count($tasks) > 0): ?>
                    <div class="tasks">
                        <?php foreach ($tasks as $task): ?>
                            <div class="task <?php echo $task['completed'] ? 'completed' : ''; ?> priority-<?php echo $task['priority']; ?>">
                                ...
                                <div class="task-actions">
                                    <a href="?delete_task=<?php echo $task['id']; ?>" class="delete-btn" onclick="return confirm('هل أنت متأكد من حذف هذه المهمة؟')">
            ...
            <div class="card">
                ...
                <?php if (count($categories) > 0): ?>
                    <div class="categories">
                        <?php foreach ($categories as $category): ?>
                            <div class="category">
                                <h3><i class="fas fa-folder"></i> <?php echo $category['name']; ?></h3>
